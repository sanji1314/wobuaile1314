				...
				<div class="panel-body">
					<form class="form-horizontal devform">
						...
						<div class="form-group">
						    ...
						    <el-input placeholder="请选择商品查看说明" type="textarea":rows="3" v-model="content" :disabled="true">
						    </el-input>
							</div>
						</div>
								        ...
								        <div class="panel-body">
								      	    <div v-for="(res,key) in rs.data">
								      	        <label class="layui-table lyear-checkbox checkbox-inline checkbox-success">
								      	  	        <li><input style="margin-left: 0px;" :checked="checked" name="checkbox" type="checkbox" :value="res.name" @click="checkResources(rs.userinfo,rs.userName,rs.data,res.name,res.id)"><span>{{res.name}} </span><span v-if="res.id!=''"> [课程ID:{{res.id}}] </span></li>
								                </label>
									      </div>
								      </div>
								    </div>
