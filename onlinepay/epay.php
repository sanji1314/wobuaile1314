...
$parameter = array(
    ...
    "type" => $type,
    "notify_url"    => get_protocol() . '://' . $row['domain'] . '/onlinepay/notify_url.php?type0='.$type0,
    "return_url"    => get_protocol() . '://' . $row['domain'] . '/onlinepay/return_url.php?type0='.$type0,
